...
<script src="js/jquery.maskedinput.min.js"></script>	
	...
	<div class="form-signin" style='max-width:420px; box-shadow: 2px 2px 5px #000000; padding-left:0%; padding-right:0%;'>      
	...
	<table class="input-group row"  >  
		...
		<td>
			...
			<span class="btn-group ">   
				...
				<button type='button' class="btn btn-default dropdown-toggle" style='width:90px'  data-toggle="dropdown">  
		...
		<td>
	  	...
	  	<td>
	  		...
	  		<span class="btn-group" > 
				...
				<button type='button'  class="btn btn-default dropdown-toggle" id='l_provider' style='width:90px; display:none;'  data-toggle="dropdown">     
	...
	<button class="btn btn-lg btn-primary" type="submit" > Next <i class="glyphicon glyphicon-arrow-right"></i></button></form>	
